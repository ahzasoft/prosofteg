...
<?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
	<div class="product_list no-print" style="width: 25%;">
       ...
       <div class="product-title">
		  <?php echo e(number_format($product->selling_price,2,'.',','), false); ?>
		...
		<div class="image-container" 
			style="height: 100px;     background-image: url(
	          ...
	          <?php if(file_exists(public_path().'/uploads/img/' . rawurlencode($product->product_image))): ?>
                  <?php echo e(asset('/uploads/img/' . rawurlencode($product->product_image)), false); ?>

					<?php else: ?>
			              <?php echo e(asset('/img/cart_1.png'), false); ?>
...
<?php endif; ?>
</div><?php /**PATH G:\laragon\www\AZHA-ERP\resources\views/sale_pos/partials/product_list.blade.php ENDPATH**/ ?>