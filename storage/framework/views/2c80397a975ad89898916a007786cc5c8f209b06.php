				...
				<div class="row">
					...
					<?php if(isset($pos_settings['enable_weighing_scale']) && $pos_settings['enable_weighing_scale'] == 1): ?>
						<div class="col-md-12">
							<div class="checkbox">
								<label>
									<?php echo Form::checkbox('search_fields[]', 'weighing_scale_barcode', true, ['class' => 'input-icheck search_fields']); ?> <?php echo app('translator')->get('lang_v1.weighing_scale_barcode'); ?>
								</label>
							</div>
						</div>
					<?php endif; ?>
...
</div><?php /**PATH G:\laragon\www\AZHA-ERP\resources\views/sale_pos/partials/configure_search_modal.blade.php ENDPATH**/ ?>