        ...
        <div class="col-sm-8" >
            <div class="form-group">
                <div class="checkbox">
                    <br>
                    <label>
                        <?php echo Form::checkbox('enable_invoic_tax',1, $business->enable_invoic_tax ,
                        [ 'class' => 'input-icheck']); ?> <?php echo e(__( 'lang_v1.enable_invoic_tax' ), false); ?>
...
<?php /**PATH G:\laragon\www\AZHA-ERP\resources\views/business/partials/settings_tax.blade.php ENDPATH**/ ?>