        ...
        <div class="col-md-4">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <?php else: ?>
                <?php echo Form::text("amount", number_format($payment_line->amount, session('business.currency_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']), ['class' => 'form-control input_number', 'required', 'placeholder' => __('sale.amount')]); ?>
        ...
        <div class="col-md-4">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <?php echo Form::text('paid_on', \Carbon::createFromTimestamp(strtotime($payment_line->paid_on))->format(session('business.date_format') . ' ' . 'h:i:s A'), ['class' => 'form-control', 'readonly', 'required']); ?>
...
</div><!-- /.modal-dialog --><?php /**PATH G:\laragon\www\AZHA-ERP\resources\views/transaction_payment/pay_supplier_due_modal.blade.php ENDPATH**/ ?>