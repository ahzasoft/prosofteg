	...
	<div class="box box-solid">
		<div class="box-body">
			<div class="row">
				...
				<div class="col-md-3">
					<div class="form-group">
						...
						<div class="<?php if(!is_array($unit_html)): ?> input-group <?php else: ?> input_inline <?php endif; ?>">
							<?php echo Form::text('total_quantity',!empty($recipe->total_quantity) ? number_format($recipe->total_quantity, session('business.currency_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']) : 1, ['class' => 'form-control input_number', 'placeholder' => __('manufacturing::lang.total_output_quantity') ]); ?>
				...
				<div class="col-md-3">
					<div class="form-group">
						<?php echo Form::label('extra_cost_type','نوع التكلفة'); ?>

						<?php echo Form::select('extra_cost_type',['0'=>'نسبة مئوية','1'=>'قيمة ثابتة'],!empty($recipe->extra_cost_type) ? $recipe->extra_cost_type : 0, ['class' => 'form-control ' ]); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\laragon\www\AZHA-ERP\Modules\Manufacturing\Providers/../Resources/views/recipe/add_ingredients.blade.php ENDPATH**/ ?>