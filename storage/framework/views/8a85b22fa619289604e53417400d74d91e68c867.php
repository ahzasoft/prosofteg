    ...
    <div class="modal-content">
     <?php echo Form::open(['url' => action('\Modules\Superadmin\Http\Controllers\SuperadminSubscriptionsController@update',$subscription->id), 'method' => 'PUT', 'id' => 'status_change_form']); ?>
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><?php echo app('translator')->get( "superadmin::lang.subscription_status"); ?></h4>
      </div>
      ...
      <div class="modal-footer">
        <button type="submit" class="btn btn-primary"><?php echo app('translator')->get( "superadmin::lang.update"); ?></button>
        <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo app('translator')->get( "superadmin::lang.close"); ?></button>
      </div>
      <?php echo Form::close(); ?>

    </div>
</div>
<?php /**PATH G:\laragon\www\prosofteg\Modules\Superadmin\Providers/../Resources/views/superadmin_subscription/edit.blade.php ENDPATH**/ ?>