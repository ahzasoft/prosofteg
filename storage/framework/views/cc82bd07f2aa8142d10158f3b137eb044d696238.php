        ...
        <div class="col-md-4">
          <div class="form-group">
              ...
              <div class="input-group">
                  ...
                  <?php echo Form::text('contact_id', $contact->contact_id, ['class' => 'form-control','placeholder' => __('lang_v1.leave_empty_to_autogenerate')]); ?>
        ...
        <div class="col-md-4 customer_fields">
              <div class="form-group">
                  ...
                  <span class="input-group-addon">
                      ...
                      <?php echo Form::select('price_group_id', $price_groups, $contact->price_group_id, ['class' => 'form-control']); ?>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <?php echo Form::text('commercial_register',  $contact->commercial_register, ['class' => 'form-control', 'placeholder' => __('lang_v1.commercial_register')]); ?>
...
</div><!-- /.modal-dialog --><?php /**PATH G:\laragon\www\AZHA-ERP\resources\views/contact/edit.blade.php ENDPATH**/ ?>