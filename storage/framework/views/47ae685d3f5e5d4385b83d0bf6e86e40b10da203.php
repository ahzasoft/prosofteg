...
<input type="hidden" id="item_addition_method" value="<?php echo e($business_details->item_addition_method, false); ?>">
	<?php echo Form::open(['url' => action('SellPosController@store'), 'method' => 'post',
	...
	<div class="row">
		<div class="col-md-12 col-sm-12">
			...
			<?php echo $__env->renderComponent(); ?>
			<!--  Shipping -->
			<?php $__env->startComponent('components.widget', ['class' => 'box-solid hidden']); ?>
			<div class="col-md-4">
				<div class="form-group">
...
<?php $__env->startSection('javascript'); ?>
	...
	<script src="<?php echo e(asset('js/directsale.js?v=' . $asset_v), false); ?>"></script>
	<!-- Call restaurant module if defined -->
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\laragon\www\AZHA-ERP\resources\views/sell/create.blade.php ENDPATH**/ ?>