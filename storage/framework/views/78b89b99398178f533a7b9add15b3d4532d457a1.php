    ...
    <div class="modal-body">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <?php echo Form::text('contact_id', null, ['class' => 'form-control','placeholder' => __('lang_v1.leave_empty_to_autogenerate')]); ?>
              ...
              <div class="input-group">
                 ...
                 <select id="price_groups" class="form-control"name="price_group_id">
                    <option value="">افتراضي </option>
                     ...
                     <?php $__currentLoopData = $price_groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($row->id, false); ?>"><?php echo e($row->name, false); ?></option>
        ...
        <div class="row">
            ...
            <div id="more_div" class="hide">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <?php echo Form::label('tax_number', __('lang_v1.commercial_register') . ':'); ?>

                        <div class="input-group">
                          <span class="input-group-addon">
                              <i class="fa fa-info"></i>
                          </span>
                            <?php echo Form::text('commercial_register', null, ['class' => 'form-control', 'placeholder' => __('lang_v1.commercial_register')]); ?>
...
</div><!-- /.modal-dialog --><?php /**PATH G:\laragon\www\AZHA-ERP\resources\views/contact/create.blade.php ENDPATH**/ ?>