    ...
    <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <div class="input-group date" id='od_datetimepicker'>
                  <?php echo Form::text('operation_date', $default_datetime, ['class' => 'form-control', 'required','placeholder' => __( 'messages.date' ) ]); ?>
...
</script><?php /**PATH G:\laragon\www\AZHA-ERP\resources\views/account/deposit.blade.php ENDPATH**/ ?>