        ...
        <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
                    <br>
                    <label>
                        <?php echo Form::checkbox('pos_settings[disable_shipping]', 1,
                           !empty($pos_settings['disable_shipping'])? $pos_settings['disable_shipping']:0,
                        [ 'class' => 'input-icheck']); ?> <?php echo e(__( 'lang_v1.disable_shipping' ), false); ?>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
                    <br>
                    <label>
                        <?php echo Form::checkbox('pos_settings[disable_checkout_card_button]', 1,
                        empty($pos_settings['disable_checkout_card_button']) ? 0 : 1 ,
                        [ 'class' => 'input-icheck']); ?> <?php echo e(__( 'lang_v1.disable_checkout_card_button' ), false); ?>
...
</div><?php /**PATH G:\laragon\www\AZHA-ERP\resources\views/business/partials/settings_pos.blade.php ENDPATH**/ ?>