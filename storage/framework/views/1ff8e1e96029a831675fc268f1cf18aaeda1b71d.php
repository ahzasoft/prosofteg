    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="col-sm-4 selected_contacts_div <?php if(!$user->selected_contacts): ?> hide <?php endif; ?>">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <div class="checkbox">
                            <br/>
                            <label>
                                <?php echo Form::checkbox('selected_department', 1,
                                $user->selected_department,
                                [ 'class' => 'input-icheck', 'id' => 'selected_department']); ?> <?php echo e(__( 'lang_v1.allow_selected_department' ), false); ?>
                ...
                <div class="col-sm-4 selected_department_div <?php if(!$user->selected_department): ?> hide <?php endif; ?>">
                    <div class="form-group">
                        <?php echo Form::label('selected_cdepartment', __('lang_v1.selected_department') . ':'); ?>

                        <div class="form-group">
                            <?php echo Form::select('selected_department_ids[]', $department, $department_access, ['class' => 'form-control select2', 'multiple', 'style' => 'width: 100%;' ]); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\laragon\www\AZHA-ERP\resources\views/manage_user/edit.blade.php ENDPATH**/ ?>