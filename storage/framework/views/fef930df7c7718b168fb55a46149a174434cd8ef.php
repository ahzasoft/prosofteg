    ...
    <?php if($is_employee_allowed): ?>
        <div class="row">
            ...
            &nbsp;&nbsp;&nbsp;
                ...
                <?php if(!empty($clock_in)): ?>
                    <br>
                    <small class="text-muted"><?php echo app('translator')->get('essentials::lang.clocked_in_at'); ?>: <?php echo e(\Carbon::createFromTimestamp(strtotime($clock_in->clock_in_time))->format(session('business.date_format') . ' ' . 'h:i:s A'), false); ?></small>
                <?php endif; ?>
            </div>
        </div>
    <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\laragon\www\AZHA-ERP\Modules\Essentials\Providers/../Resources/views/attendance/index.blade.php ENDPATH**/ ?>