...
<head>
    ...
    <title>
        <?php echo e(config('app.name', 'AZHA Soft POS'), false); ?>
    ...
    <style>
        ...
        .badge.level-all, .level.level-all, .info-box.level-all {
            background-color: <?php echo e(log_styler()->color('all'), false); ?>;
        }

        .badge.level-emergency, .level.level-emergency, .info-box.level-emergency {
            background-color: <?php echo e(log_styler()->color('emergency'), false); ?>;
        }

        .badge.level-alert, .level.level-alert, .info-box.level-alert  {
            background-color: <?php echo e(log_styler()->color('alert'), false); ?>;
        }

        .badge.level-critical, .level.level-critical, .info-box.level-critical {
            background-color: <?php echo e(log_styler()->color('critical'), false); ?>;
        }

        .badge.level-error, .level.level-error, .info-box.level-error {
            background-color: <?php echo e(log_styler()->color('error'), false); ?>;
        }

        .badge.level-warning, .level.level-warning, .info-box.level-warning {
            background-color: <?php echo e(log_styler()->color('warning'), false); ?>;
        }

        .badge.level-notice, .level.level-notice, .info-box.level-notice {
            background-color: <?php echo e(log_styler()->color('notice'), false); ?>;
        }

        .badge.level-info, .level.level-info, .info-box.level-info {
            background-color: <?php echo e(log_styler()->color('info'), false); ?>;
        }

        .badge.level-debug, .level.level-debug, .info-box.level-debug {
            background-color: <?php echo e(log_styler()->color('debug'), false); ?>;
        }

        .badge.level-empty, .level.level-empty {
            background-color: <?php echo e(log_styler()->color('empty'), false); ?>;
        }
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a href="<?php echo e(route('log-viewer::dashboard'), false); ?>" class="navbar-brand">
            ...
            <div class="collapse navbar-collapse" id="navbar">
                <ul class="nav navbar-nav">
                    <li class="<?php echo e(Route::is('log-viewer::dashboard') ? 'active' : '', false); ?>">
                        <a href="<?php echo e(route('log-viewer::dashboard'), false); ?>">
                            <i class="fa fa-dashboard"></i> Dashboard
                        </a>
                    </li>
                    <li class="<?php echo e(Route::is('log-viewer::logs.list') ? 'active' : '', false); ?>">
                        <a href="<?php echo e(route('log-viewer::logs.list'), false); ?>">
    ...
    <footer class="main-footer">
        <div class="container">
            <p class="text-muted pull-right">
                <small>
                    <?php echo e(config('app.name', 'AZHA Soft POS'), false); ?> - V<?php echo e(config('author.app_version'), false); ?> | Copyright &copy; <?php echo e(date('Y'), false); ?> All rights reserved.
                </small>
            </p>
        </div>
    </footer>
...
<?php /**PATH G:\laragon\www\AZHA-ERP\resources\views/vendor/log-viewer/bootstrap-3/_master.blade.php ENDPATH**/ ?>