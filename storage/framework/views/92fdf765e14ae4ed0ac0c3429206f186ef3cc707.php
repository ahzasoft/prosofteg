<tr>
    ...
    <td <?php if($count_child_payments > 0): ?> rowspan="<?php echo e($count_child_payments + 1, false); ?>" style="vertical-align:middle;" <?php endif; ?>>
        <?php echo e(\Carbon::createFromTimestamp(strtotime($payment->paid_on))->format(session('business.date_format') . ' ' . 'h:i:s A'), false); ?>
...
</tr><?php /**PATH G:\laragon\www\AZHA-ERP\resources\views/contact/partials/payment_row.blade.php ENDPATH**/ ?>