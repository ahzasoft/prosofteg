  ...
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      <?php endif; ?>
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('account.fund-transfer')): ?>
        <button data-href="<?php echo e(action('AccountController@getFundTransfer',[1]), false); ?>" class="btn btn-danger btn-flat m-6 btn-xs m-5 pull-right btn-modal" data-container=".view_modal"><i class="fa fa-exchange"></i> <?php echo app('translator')->get("account.fund_transfer"); ?></button>
        <?php endif; ?>
    <?php
...
<?php /**PATH G:\laragon\www\AZHA-ERP\resources\views/layouts/partials/header-pos.blade.php ENDPATH**/ ?>