<?php if($__is_essentials_enabled && $is_employee_allowed): ?>
	...
	<button 
	    ...
	    title="<?php echo app('translator')->get('essentials::lang.clock_out'); ?> <?php if(!empty($clock_in)): ?>
                    <br><small>(<?php echo app('translator')->get('essentials::lang.clocked_in_at'); ?>: <?php echo e(\Carbon::createFromTimestamp(strtotime($clock_in->clock_in_time))->format(session('business.date_format') . ' ' . 'h:i:s A'), false); ?>)</small>
                <?php endif; ?>" 
	    >
	    <i class="fas fa-hourglass-half fa-spin"></i>
	</button>
<?php endif; ?><?php /**PATH G:\laragon\www\AZHA-ERP\Modules\Essentials\Providers/../Resources/views/layouts/partials/header_part.blade.php ENDPATH**/ ?>