...
<div class="col-md-12 col-sm-12 <?php if(!empty($for_pdf)): ?> width-100 align-left <?php endif; ?>">
	<p class="text-left align-left"><strong><?php echo e($contact->business->name, false); ?></strong>
		...
		<div class="col-md-6 col-sm-6 col-xs-12">
            ...
            $formated_number .= number_format((float) $ledger_details['balance_due'], session("business.currency_precision", 2) , session("currency")["decimal_separator"], session("currency")["thousand_separator"]);
		...
		<tbody>
			<?php $__currentLoopData = $ledger_details['ledger']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<tr <?php if(!empty($for_pdf) && $loop->iteration % 2 == 0): ?> class="odd" <?php endif; ?>>
					<td class="row-border"><?php echo e(\Carbon::createFromTimestamp(strtotime($data['date']))->format(session('business.date_format') . ' ' . 'h:i:s A'), false); ?></td>
...
<?php /**PATH G:\laragon\www\AZHA-ERP\resources\views/contact/ledger.blade.php ENDPATH**/ ?>