	                        ...
	                        <tbody>
		                        <?php $__empty_1 = true; $__currentLoopData = $todays_attendances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attendance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
	                                <tr>
	                                    ...
	                                    <td>
	                                    	<?php echo e(\Carbon::createFromTimestamp(strtotime($attendance->clock_in_time))->format(session('business.date_format') . ' ' . 'h:i:s A'), false); ?>
	                                    ...
	                                    <td>
	                                    	<?php if(!empty($attendance->clock_out_time)): ?>
	                                    		<?php echo e(\Carbon::createFromTimestamp(strtotime($attendance->clock_out_time))->format(session('business.date_format') . ' ' . 'h:i:s A'), false); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\laragon\www\AZHA-ERP\Modules\Essentials\Providers/../Resources/views/dashboard/hrm_dashboard.blade.php ENDPATH**/ ?>