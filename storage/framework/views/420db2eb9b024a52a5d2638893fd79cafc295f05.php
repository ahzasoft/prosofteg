 <?php if(count($module_permissions) > 0): ?>
  ...
  <div class="row check_group">
    <div class="col-md-3">
      <h4><?php echo app('translator')->get(strtolower($key).'::lang.'.strtolower($key)); ?></h4>
    </div>
    <div class="col-md-9">
  ...
  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php endif; ?><?php /**PATH G:\laragon\www\prosofteg\resources\views/role/partials/module_permissions.blade.php ENDPATH**/ ?>