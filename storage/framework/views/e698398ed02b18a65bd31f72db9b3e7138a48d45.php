	...
	<div class="<?php echo e($col_class, false); ?>">
		<div class="form-group">
			...
			<div class="input-group">
				...
				<?php echo Form::text("payment[$row_index][amount]", '', ['class' => 'form-control payment-amount input_number', 'required', 'id' => "amount_$row_index", 'placeholder' => __('sale.amount'), 'readonly' => $readonly]); ?>
	...
	<div class="<?php echo e($col_class, false); ?>">
		<div class="form-group">
			...
			<div class="input-group">
              ...
              <?php echo Form::text("payment[$row_index][paid_on]", isset($payment_line['paid_on']) ? \Carbon::createFromTimestamp(strtotime($payment_line['paid_on']))->format(session('business.date_format') . ' ' . 'h:i:s A') : \Carbon::createFromTimestamp(strtotime('now'))->format(session('business.date_format') . ' ' . 'h:i:s A'), ['class' => 'form-control paid_on', 'readonly', 'required']); ?>
...
</div><?php /**PATH G:\laragon\www\AZHA-ERP\resources\views/sale_pos/partials/payment_row_form.blade.php ENDPATH**/ ?>