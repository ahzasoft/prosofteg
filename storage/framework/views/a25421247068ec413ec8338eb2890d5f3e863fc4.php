            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                <?php echo Form::checkbox('permissions[]', 'expenses.categories', in_array('expenses.categories', $role_permissions),
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                <?php echo Form::checkbox('permissions[]', 'expenses.create', in_array('expenses.create', $role_permissions),
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                <?php echo Form::checkbox('permissions[]', 'expenses.edit',  in_array('expenses.edit', $role_permissions),
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                <?php echo Form::checkbox('permissions[]', 'expenses.delete',  in_array('expenses.delete', $role_permissions),
                ...
                <div class="row check_group">
                    ...
                    <div class="col-md-9">
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    <?php echo Form::checkbox('permissions[]', 'total_report_main', in_array('total_report_main', $role_permissions),
                                    [ 'class' => 'input-icheck']); ?> <?php echo e(__( 'role.total_report_main' ), false); ?>
                        ...
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    <?php echo Form::checkbox('permissions[]', 'product.ProductStockAlert', in_array('product.ProductStockAlert', $role_permissions),
                                    [ 'class' => 'input-icheck']); ?> <?php echo e(__( 'role.product.ProductStockAlert' ), false); ?>
            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                <?php echo Form::checkbox('permissions[]', 'account.fund-transfer', in_array('account.fund-transfer', $role_permissions),
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                <?php echo Form::checkbox('permissions[]', 'account.add', in_array('account.add', $role_permissions),
                    ...
                    <div class="row check_group">
                        ...
                        <div class="col-md-9">
                            <div class="col-md-12">
                                <div class="checkbox">
                                    <label>
                                        <?php echo Form::checkbox('permissions[]', 'restaurant.view', in_array('restaurant.view', $role_permissions),
                                        [ 'class' => 'input-icheck']); ?> <?php echo e(__('lang_v1.restaurant.view'), false); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\laragon\www\prosofteg\resources\views/role/edit.blade.php ENDPATH**/ ?>