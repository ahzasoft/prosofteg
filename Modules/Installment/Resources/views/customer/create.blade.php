            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="form-group">
                        ...
                        <input type="text" name='total_fat' id="total_fat" value=" {{@number_format($total,2,'.','')}}" class="form-control decimal intallparameter" readonly >
                    </div>
                </div>
                ...
                <div class="col-lg-3">
                    <div class="form-group">
                        ...
                        <input type="text" name='total_paid' id="total_paid" value=" {{ @number_format($total_paid,2,'.','')}}" class="form-control decimal intallparameter"  readonly >
                    </div>
                </div>
                ...
                <div class="col-lg-3">
                    <div class="form-group">
                        ...
                        <input type="text" name='total_req' id="total_req" value=" {{ @number_format($total-$total_paid,2,'.','')}}" class="form-control decimal intallparameter" readonly >
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="text" name='installment_value' id="installment_value" value=" {{ @number_format($total-$total_paid,2,'.','')}}" class="form-control decimal intallparameter" required autocomplete="off" >
                    </div>
                </div>
